...
public class UserRegImplemtation implements IUserRegistration {
	...
	public boolean validateFName(String fName) {
		...
		Predicate<String> predicate = (fname)->{ return pat.matcher(fname).matches();};
		boolean predicateFName = (predicate.test(fName));
		if (predicateFName == true) {
	...
	public boolean validateLname(String lName) {
		...
		Predicate<String> predicate = (lname)->{ return pat.matcher(lname).matches();};
		boolean predicateLName = (predicate.test(lName));
		if(predicateLName == true) {
			System.out.println("Input is valid!!");
			return true;
		}else {
			System.out.println("Input is Invalid!!");
	...
	public boolean valdateEmail(String email) {
		...
		Predicate<String> predicate = (eMail)->{ return pat.matcher(eMail).matches();};
		boolean predicateEmail = (predicate.test(email));
		if(predicateEmail == true) {
			System.out.println("Input is valid!!");
			return true;
		}else {
			System.out.println("Input is Invalid!!");
	...
	public boolean validatephoneNumber(String phone) {
		...
		Predicate<String> predicate = (pNum)->{ return pat.matcher(pNum).matches();};
		boolean predicatePNum = (predicate.test(phone));
		if(predicatePNum ==  true) {
			System.out.println("Input is valid!!");
			return true;
		}else {
			System.out.println("Input is Invalid!!");
	...
	public boolean validatePwd(String pwd) {
		...
		Predicate<String> predicate = (passw)->{ return pat.matcher(passw).matches();};
		boolean predicatePwd = (predicate.test(pwd));
		if(predicatePwd == true) {
			System.out.println("Input is valid!!");
